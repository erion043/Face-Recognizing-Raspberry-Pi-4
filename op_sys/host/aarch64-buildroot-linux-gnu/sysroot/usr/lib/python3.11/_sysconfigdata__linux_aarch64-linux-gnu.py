...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': '/home/erion/Projects/buildroot/output/host/bin/aarch64-buildroot-linux-gnu-gcc '
              '-shared',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIG_ARGS': "'--target=aarch64-buildroot-linux-gnu' "
                ...
                "'--disable-sqlite3' '--disable-openssl' "
                "'--disable-codecs-cjk' '--disable-uuid' '--disable-bzip2' "
                "'--disable-xz' '--disable-zlib' '--disable-ossaudiodev' "
                "'--without-ensurepip' '--without-cxx-main' "
                "'--with-build-python=/home/erion/Projects/buildroot/output/host/bin/python3' "
                ...
                "'CPP=/home/erion/Projects/buildroot/output/host/bin/aarch64-buildroot-linux-gnu-cpp'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/erion/Projects/buildroot/output/build/python3-3.11.8/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/home/erion/Projects/buildroot/output/build/python3-3.11.8/lcov-report',
 ...
 'CPPFLAGS': '-I. -I./Include -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE '
             '-D_FILE_OFFSET_BITS=64',
 'CXX': '/home/erion/Projects/buildroot/output/host/bin/aarch64-buildroot-linux-gnu-g++',
 ...
 'DFLAGS': '',
 'DIRMODE': 755,
 'DISABLED_EXTENSIONS': 'pyexpat _decimal ossaudiodev _sqlite3 _codecs_kr '
                        '_codecs_jp _codecs_cn _codecs_tw _codecs_hk '
                        '_codecs_iso2022 nis ssl _ssl _hashlib readline _bz2 '
                        'zlib _lzma _tkinter _curses _curses_panel _uuid _dbm',
 ...
 'FREEZE_MODULE': '/home/erion/Projects/buildroot/output/host/bin/python3 '
                  './Programs/_freeze_module.py',
 'FREEZE_MODULE_BOOTSTRAP': '/home/erion/Projects/buildroot/output/host/bin/python3 '
                            './Programs/_freeze_module.py',
 ...
 'HAVE__GETPTY': 0,
 'HOSTRUNNER': '',
 'HOST_GNU_TYPE': 'aarch64-buildroot-linux-gnu',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': '/home/erion/Projects/buildroot/output/host/bin/aarch64-buildroot-linux-gnu-g++ '
                '-shared',
 'LDFLAGS': '',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.11.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': '/home/erion/Projects/buildroot/output/host/bin/aarch64-buildroot-linux-gnu-gcc '
             '-shared',
 'LDVERSION': '3.11',
 'LIBC': '',
 ...
 'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_64=1 -DANSI=1 '
                    '-DHAVE_UINT128_T=1 -Wsign-compare -DNDEBUG -g  -O3 -Wall '
                    '-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE '
                    '-D_FILE_OFFSET_BITS=64  -O2 -g0 -D_FORTIFY_SOURCE=1 '
                    '-std=c11 -Wextra -Wno-unused-parameter '
                    '-Wno-missing-field-initializers -Wstrict-prototypes '
 ...
 'LIBPL': '/usr/lib/python3.11/config-3.11-aarch64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LIBS': '-ldl  -lpthread',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': '/home/erion/Projects/buildroot/output/host/bin/aarch64-buildroot-linux-gnu-gcc',
 ...
 'MAINCC': '/home/erion/Projects/buildroot/output/host/bin/aarch64-buildroot-linux-gnu-gcc',
 'MAJOR_IN_MKDEV': 0,
 ...
 'MODULE_BINASCII_LDFLAGS': '-L/home/erion/Projects/buildroot/output/host/bin/../aarch64-buildroot-linux-gnu/sysroot/usr/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '',
 'MODULE_ZLIB_LDFLAGS': '-L/home/erion/Projects/buildroot/output/host/bin/../aarch64-buildroot-linux-gnu/sysroot/usr/lib '
                        '-lz',
 ...
 'MODULE__HASHLIB_LDFLAGS': '-L/home/erion/Projects/buildroot/output/host/bin/../aarch64-buildroot-linux-gnu/sysroot/usr/lib    '
                            '-lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '',
 'MODULE__LZMA_LDFLAGS': '-L/home/erion/Projects/buildroot/output/host/bin/../aarch64-buildroot-linux-gnu/sysroot/usr/lib '
                         '-llzma',
 ...
 'MODULE__SSL_LDFLAGS': '-L/home/erion/Projects/buildroot/output/host/bin/../aarch64-buildroot-linux-gnu/sysroot/usr/lib   '
                        '-lssl -lcrypto',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '',
 'OPENSSL_LDFLAGS': '-L/home/erion/Projects/buildroot/output/host/bin/../aarch64-buildroot-linux-gnu/sysroot/usr/lib',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/erion/Projects/buildroot/output/build/python3-3.11.8 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=./Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-gnu '
                     '_PYTHON_SYSCONFIGDATA_PATH=$(shell test -f '
                     'pybuilddir.txt && echo '
                     '/home/erion/Projects/buildroot/output/build/python3-3.11.8/`cat '
                     'pybuilddir.txt`) '
                     '/home/erion/Projects/buildroot/output/host/bin/python3',
 'PYTHON_FOR_BUILD_DEPS': '',
 'PYTHON_FOR_FREEZE': '/home/erion/Projects/buildroot/output/host/bin/python3',
 'PYTHON_FOR_REGEN': '',
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g  -O3 -Wall '
                             ...
                             '-D_FORTIFY_SOURCE=1 -std=c11 -Wextra '
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g  -O3 -Wall -D_LARGEFILE_SOURCE '
                   '-D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64  -O2 -g0 '
                   '-D_FORTIFY_SOURCE=1 -std=c11 -Wextra -Wno-unused-parameter '
                   '-Wno-missing-field-initializers -Wstrict-prototypes '
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/home/erion/Projects/buildroot/output/build/python3-3.11.8 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-gnu '
               ...
               '/home/erion/Projects/buildroot/output/host/bin/python3',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/home/erion/Projects/buildroot/output/build/python3-3.11.8 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=./Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_aarch64-linux-gnu '
               '_PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && '
 ...
 'abs_builddir': '/home/erion/Projects/buildroot/output/build/python3-3.11.8',
 'abs_srcdir': '/home/erion/Projects/buildroot/output/build/python3-3.11.8',
