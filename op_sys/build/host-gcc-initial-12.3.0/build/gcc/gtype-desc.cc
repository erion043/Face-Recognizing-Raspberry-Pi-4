...
gt_ggc_mx_cl_target_option (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_S ((*x).x_aarch64_override_tune_string);
      gt_ggc_m_S ((*x).x_aarch64_branch_protection_string);
    }
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(SP_REGNUM);
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_7rtx_def ((*x).call_via[i0]);
        }
      }
      gt_ggc_m_14hash_set_tree_ ((*x).vector_load_decls);
    }
}
...
gt_pch_nx_cl_target_option (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_16cl_target_option))
    {
      gt_pch_n_S ((*x).x_aarch64_override_tune_string);
      gt_pch_n_S ((*x).x_aarch64_branch_protection_string);
    }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_16machine_function))
    {
      ...
      gt_pch_n_14hash_set_tree_ ((*x).vector_load_decls);
    }
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    gt_pch_note_callback (&((*x).reallocator), this_obj);
  if ((void *)(x) == this_obj)
    gt_pch_note_callback (&((*x).round_alloc_size), this_obj);
  {
    size_t l3 = (size_t)(((*x).location_adhoc_data_map).allocated);
    if ((*x).location_adhoc_data_map.data != NULL) {
      size_t i3;
      ...
      if ((void *)(x) == this_obj)
        op (&((*x).location_adhoc_data_map.data), NULL, cookie);
    }
  }
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).x_aarch64_override_tune_string), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_aarch64_branch_protection_string), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct machine_function * x ATTRIBUTE_UNUSED = (struct machine_function *)x_p;
  {
    ...
    for (i0 = 0; i0 != l0; i0++) {
      if ((void *)(x) == this_obj)
        op (&((*x).call_via[i0]), NULL, cookie);
    }
  }
  if ((void *)(x) == this_obj)
    op (&((*x).vector_load_decls), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).agg_values), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).bits), NULL, cookie);
  if ((void *)(x) == this_obj)
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gtype_desc_cc[] = {
  ...
  },
  {
    ...
    1,
    sizeof (aarch64_bf16_ptr_type_node),
    &gt_ggc_mx_tree_node,
    &gt_pch_nx_tree_node
  },
  {
  ...
  },
  {
    ...
    1,
    sizeof (aarch64_fp16_ptr_type_node),
    &gt_ggc_mx_tree_node,
    &gt_pch_nx_tree_node
  },
  {
