...
(*.[0-9]*)
	...
	if test ! -f "/home/erion/Projects/buildroot/output/build/ncurses-6.4-20230603/man_alias.sed" ; then
cat >>/home/erion/Projects/buildroot/output/build/ncurses-6.4-20230603/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/erion/Projects/buildroot/output/build/ncurses-6.4-20230603/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$cf_full_alias" |sed -f "/home/erion/Projects/buildroot/output/build/ncurses-6.4-20230603/man_alias.sed" | sort -u; test "$cf_part_alias" = "$nCurses" && echo curses`
	...
	sed	-f "/home/erion/Projects/buildroot/output/build/ncurses-6.4-20230603/man_alias.sed" \
		< "$i" >$TMP
