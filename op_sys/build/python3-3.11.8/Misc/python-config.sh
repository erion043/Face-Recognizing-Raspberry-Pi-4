...
CFLAGS=$(echo "-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64  -O2 -g0 -D_FORTIFY_SOURCE=1" | sed "s#^$prefix_build#$prefix_real#")
VERSION="3.11"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
...
LIBPL=$(echo "$(prefix)/lib/python3.11/config-$(VERSION)$(ABIFLAGS)-aarch64-linux-gnu" | sed "s#^$prefix_build#$prefix_real#")
