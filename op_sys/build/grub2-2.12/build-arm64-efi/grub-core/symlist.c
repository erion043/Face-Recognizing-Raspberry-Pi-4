  ...
  static struct symtab tab[] =
    {
      ...
      {"grub_acpi_find_table", grub_acpi_find_table, 1},
      {"grub_arch_sync_caches", grub_arch_sync_caches, 1},
      ...
      {"grub_efi_close_protocol", grub_efi_close_protocol, 1},
      ...
      {"grub_efi_find_configuration_table", grub_efi_find_configuration_table, 1},
      ...
      {"grub_efi_get_firmware_fdt", grub_efi_get_firmware_fdt, 1},
      {"grub_efi_get_loaded_image", grub_efi_get_loaded_image, 1},
      {"grub_efi_get_memory_map", grub_efi_get_memory_map, 1},
      {"grub_efi_get_ram_base", grub_efi_get_ram_base, 1},
      {"grub_efi_get_secureboot", grub_efi_get_secureboot, 1},
      {"grub_efi_get_variable", grub_efi_get_variable, 1},
      {"grub_efi_get_variable_with_attributes", grub_efi_get_variable_with_attributes, 1},
      ...
      {"grub_efi_set_variable_to_string", grub_efi_set_variable_to_string, 1},
      {"grub_efi_set_variable_with_attributes", grub_efi_set_variable_with_attributes, 1},
      ...
      {"grub_env_get_bool", grub_env_get_bool, 1},
      ...
      {"grub_is_lockdown", grub_is_lockdown, 1},
      {"grub_is_shim_lock_enabled", grub_is_shim_lock_enabled, 1},
      ...
      {"grub_mm_add_region_fn", (void *) &grub_mm_add_region_fn, 0},
      ...
      {"grub_utf8_to_utf16_alloc", grub_utf8_to_utf16_alloc, 1},
