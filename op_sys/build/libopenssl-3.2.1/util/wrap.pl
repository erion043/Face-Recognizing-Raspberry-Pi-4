...
BEGIN {
    ...
    require '/home/erion/Projects/buildroot/output/build/libopenssl-3.2.1/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/erion/Projects/buildroot/output/build/libopenssl-3.2.1/test/fips-and-base.cnf';
    shift;
