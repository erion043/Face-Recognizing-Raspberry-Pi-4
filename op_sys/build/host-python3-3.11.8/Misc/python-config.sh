...
prefix_build="/home/erion/Projects/buildroot/output/host"
...
CFLAGS=$(echo "-O2 -I/home/erion/Projects/buildroot/output/host/include" | sed "s#^$prefix_build#$prefix_real#")
VERSION="3.11"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
