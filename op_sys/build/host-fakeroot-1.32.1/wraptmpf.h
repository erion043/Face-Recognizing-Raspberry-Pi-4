...
int tmp_setpriority (int which, id_t who, int prio){
  load_library_symbols();
...
#ifdef TIME64_HACK
int TMP_LSTAT64_TIME64 LSTAT64_TIME64_ARG(int ver, const char *file_name, struct stat64 *buf){
  load_library_symbols();
  return  NEXT_LSTAT64_TIME64_NOARG LSTAT64_TIME64_ARG(ver, file_name, buf);
}

int TMP_STAT64_TIME64 STAT64_TIME64_ARG(int ver, const char *file_name, struct stat64 *buf){
  load_library_symbols();
  return  NEXT_STAT64_TIME64_NOARG STAT64_TIME64_ARG(ver, file_name, buf);
}

int TMP_FSTAT64_TIME64 FSTAT64_TIME64_ARG(int ver, int fd, struct stat64 *buf){
  load_library_symbols();
  return  NEXT_FSTAT64_TIME64_NOARG FSTAT64_TIME64_ARG(ver, fd, buf);
}

int TMP_FSTATAT64_TIME64 FSTATAT64_TIME64_ARG(int ver, int dir_fd, const char *path, struct stat64 *buf, int flags){
  load_library_symbols();
  return  NEXT_FSTATAT64_TIME64_NOARG FSTATAT64_TIME64_ARG(ver, dir_fd, path, buf, flags);
}
